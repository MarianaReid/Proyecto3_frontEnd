...
const Error = () => {
    return (
      ...
      <div className="container pt-4">
        ...
        {/* <Button className='ov-btn-slide-bottom'>Volver a inicio</Button> */}
        <a href='/' className='ov-btn-slide-bottom'>VOLVER A INICIO</a>
        {/* <Link to='/' className='ov-btn-slide-bottom'>HOLA</Link> */}
      </div>
